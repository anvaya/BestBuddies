...
/**
 * question_option form base class.
 *
 * @method question_option getObject() Returns the current form's model object
 *
 * @package    BestBuddies
 * @subpackage form
 ...
 */
abstract class Basequestion_optionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('question_option[%s]');
