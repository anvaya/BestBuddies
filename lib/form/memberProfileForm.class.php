...
class memberProfileForm extends BasememberForm
{
    public function configure()
    {
        ...
        $dataCollectionForm = new submissionDataCollectionForm(array(), array("submission"=>$submission,"question_ids"=>array(17,18,19) ) );
        $this->embedForm("emergency_data", $dataCollectionForm);
        
        $dataCollectionForm = new submissionDataCollectionForm(array(), array("submission"=>$submission,"question_ids"=>array(8,9,10,11,12,13) ) );
        $this->embedForm("address_data", $dataCollectionForm);
        
        $dataCollectionForm = new submissionDataCollectionForm(array(), array("submission"=>$submission,"question_ids"=>array(14,15,16,20,21,22) ) );
