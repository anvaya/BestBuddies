 ...
 * @property Doctrine_Collection $reminder
 * 
 ...
 * @method Doctrine_Collection getReminder()         Returns the current record's "reminder" collection
 ...
 * @method submission_form     setReminder()         Sets the current record's "reminder" collection
 * 
 * @package    BestBuddies
 * @subpackage model
...
abstract class Basesubmission_form extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('reminder', array(
             'local' => 'id',
             'foreign' => 'submission_form_id'));
    }
}