...
/**
 * question_option filter form base class.
 *
 * @package    BestBuddies
 * @subpackage filter
 ...
 */
abstract class Basequestion_optionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('question_option_filters[%s]');
