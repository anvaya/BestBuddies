...
<div id="sf_admin_container">
  <h1><?php echo __('Calendar event List', array(), 'messages') ?></h1>

  <?php include_partial('calendar_event/flashes') ?>

  <div id="sf_admin_header">
    <?php include_partial('calendar_event/list_header', array('pager' => $pager)) ?>
  </div>

  <div id="sf_admin_bar">
    <?php include_partial('calendar_event/filters', array('form' => $filters, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('calendar_event_collection', array('action' => 'batch')) ?>" method="post">
