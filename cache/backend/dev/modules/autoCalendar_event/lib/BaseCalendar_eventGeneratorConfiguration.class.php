...
abstract class BaseCalendar_eventGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%event_type%% - %%title%% - %%from_date%% - %%to_date%% - %%city%%';
  }
  ...
  {
    return array(  0 => 'member_id',  1 => 'event_type_id',  2 => 'from_date',  3 => 'to_date',  4 => 'city',  5 => 'status',);
  }

  public function getFormDisplay()
  {
    return array(  'Event' =>   array(    0 => 'title',    1 => 'event_type_id',    2 => 'from_date',    3 => 'to_date',    4 => 'description',    5 => 'status',  ),  'Location' =>   array(    0 => 'address',    1 => 'city',    2 => 'state',    3 => 'zip',  ),  'Contact' =>   array(    0 => 'contact_person',    1 => 'phone_number',    2 => 'email_address',    3 => 'website',  ),);
  }
  ...
  {
    return array(  0 => 'event_type',  1 => 'title',  2 => 'from_date',  3 => 'to_date',  4 => 'city',);
  }
  ...
  public function getFieldsFilter()
  {
    return array(
      'id' => array(),
      'member_id' => array(  'label' => 'Created By',),
      'event_type_id' => array(),
      'from_date' => array(),
      'to_date' => array(),
      'title' => array(),
